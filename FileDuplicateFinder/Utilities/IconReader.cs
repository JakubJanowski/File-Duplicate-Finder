...
namespace FileDuplicateFinder.Utilities {
    ...
    public static class IconReader {
        ...
        public static ImageSource GetFileIcon(string path, IconSize size, bool linkOverlay) {
            ...
            Shell32.SHGetFileInfo(path, Shell32.FILE_ATTRIBUTE_NORMAL, ref shfi, (uint)Marshal.SizeOf(shfi), flags);
        ...
        public static ImageSource GetFolderIcon(string path, IconSize size, FolderType folderType) {
            ...
            // Get the folder icon
            Shell32.SHFILEINFO shfi = new Shell32.SHFILEINFO();
            Shell32.SHGetFileInfo(path, Shell32.FILE_ATTRIBUTE_DIRECTORY, ref shfi, (uint)Marshal.SizeOf(shfi), flags);
